# DisRoute 0.4.1 — Windows preview
...
Users of 0.3.0 and earlier must install 0.4.1 manually once. Updates after 0.4.1 can be installed from inside DisRoute. The updater signature protects the update channel, but the Windows installer is not yet Authenticode-signed and may still trigger SmartScreen.
